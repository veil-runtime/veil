...
Later unversioned reasoning-boundary work is recorded separately in the
[unreleased compatibility notes](unreleased.html); it must not be
retroactively read as part of this original candidate checkpoint.
...
is `version: '1.0'`. Later branch work adds opt-in V2 semantics without rewriting
this historical candidate scope.
